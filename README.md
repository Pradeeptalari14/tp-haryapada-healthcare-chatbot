# 🏥 Generative AI Healthcare Chatbot (Minds of India)

> Haryapada health assistant chatbot referencing verified Indian medical articles. Sends alerts via email/SMS templates.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-haryapada-healthcare-chatbot.git
cd tp-haryapada-healthcare-chatbot
```
...
```bash
kubectl port-forward deployment/tp-haryapada-healthcare-chatbot 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
```text
tp-haryapada-healthcare-chatbot/
...
└── primary_config/
    └── healthcare_chatbot.py     # Main configuration file
```
...
---
*Generated by [Generative AI Healthcare Chatbot (Minds of India) Studio](https://pradeeptalari14.github.io/portfolio/tools/haryapada-healthcare-chatbot/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
